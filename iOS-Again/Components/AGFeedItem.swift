...
class AGFeedItem: UIStackView {
    required init() {
        ...
        let divideLine: UIView = {
            ...
            line.backgroundColor = UIColor(red: 16 / 255, green: 128 / 255, blue: 128 / 255, alpha: 1)
            
            return line
        }()
        
        [header, contentTexts, divideLine].forEach { self.addArrangedSubview($0) }
